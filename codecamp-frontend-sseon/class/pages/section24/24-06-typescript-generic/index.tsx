...
const result = getUnkown("철수", 123, true);
...
const result = getGeneric<string, string, number>("철수", "123", 123);
...
const result = getGeneric2("철수", "123", 123);
...
const result = getGeneric3("철수", "123", 123);
...
const result = getGeneric4("철수", "123", 123);
